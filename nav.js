...
(function () {
  var HTML = [
    ...
    '        <a href="/temple" class="pw-nav-item">3 · Temple</a>',
    '        <a href="/temper" class="pw-nav-item">4 · Temper</a>',
    '        <a href="/harden" class="pw-nav-item">5 · Harden</a>',
    '        <a href="/anneal" class="pw-nav-item">6 · Anneal</a>',
    '      </div>',
    '    </div>',
    ...
    '        <a href="/greenfield" class="pw-nav-item">Journey · Greenfield</a>',
    '        <a href="/brownfield" class="pw-nav-item">Journey · Brownfield</a>',
    '        <a href="/onboarding" class="pw-nav-item">Journey · Onboarding</a>',
    '        <a href="/migration" class="pw-nav-item">Journey · Migration</a>',
    ...
    '        <a href="/gates" class="pw-nav-item">Quality Gates</a>',
    '        <a href="/sample-report" class="pw-nav-item"><span lang="en">Sample Report</span><span lang="es">Reporte de Muestra</span></a>',
    '        <a href="/spec" class="pw-nav-item"><span lang="en">Spec Completeness</span><span lang="es">Spec Completa</span></a>',
    '        <a href="/findings" class="pw-nav-item"><span lang="en">Research Findings</span><span lang="es">Hallazgos</span></a>',
  ...
  var SECTIONS = {
    ...
    '/harden': 'forge', '/anneal': 'forge',
    '/forge': 'reference', '/properties': 'reference', '/diseases': 'reference', '/gates': 'reference',
    '/spec': 'reference', '/findings': 'reference', '/sample-report': 'reference',
